...
@interface MassageWebViewController ()<MBProgressHUDDelegate,WKNavigationDelegate>

@property (nonatomic, strong) WKWebView *webView;

@end

@implementation MassageWebViewController
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:@"https://www.ys137.com/zyys/1769008.html"];
